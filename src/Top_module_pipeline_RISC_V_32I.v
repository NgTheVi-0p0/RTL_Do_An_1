...
data_memory dmem (
        .clk          (clk),               // Xung nhịp
        .mem_write    (memWrite_M),        // Lấy cờ ghi từ tầng MEM
        .addr         (mem_alu_result_M),  // Đ/c bộ nhớ cần truy cập từ MEM
        .write_data   (rs2_data_M),        // Dữ liệu cần ghi vào từ MEM
        .load_sel     (load_sel_M),        // Lấy định dạng đọc từ MEM
        .store_sel    (store_sel_M),       // Lấy định dạng ghi từ MEM
